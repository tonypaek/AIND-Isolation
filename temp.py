...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        # Test the case by returning the list of any legeal moves
        ...
        **********************************************************************
        ...
        def min_value(g,d):
            # Takes as an input the gameboard and depth and return the min possible value among the moves
            if self.time_left() < self.TIMER_THRESHOLD:
                raise SearchTimeout()
            if not g.get_legal_moves():
                return 1
